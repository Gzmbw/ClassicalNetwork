...
import numpy as np
from checkpoint_weights_dict import CheckpointWeightsDict

class AlexNet(CheckpointWeightsDict):
    """Implementation of the AlexNet."""

    def __init__(self, x, keep_prob, num_classes, skip_layer,
                 weights_path='DEFAULT',path=None):
        ...
        CheckpointWeightsDict.__init__(self)
    ...
    def load_initial_weights(self, session):
        ...
        if self.WEIGHTS_PATH == 'bvlc_alexnet.npy':
            weights_dict = np.load(self.WEIGHTS_PATH, encoding='bytes').item()
        else:
            check =CheckpointWeightsDict()
            w = check.checkpoint_weights()
            weights_dict = w.weights_dict
